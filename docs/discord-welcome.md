...
- Virtual Spotter — proximity and blind spot awareness
- Live Leaderboard — gap times, positions, pit status
- Datastream — scrolling telemetry data feed
- WebGL Effects — GPU-accelerated glare, bloom, and panel glow
- Ambient Reflections — screen-capture driven light reflections on HUD panels
- Module Customization — show/hide and configure every HUD element
...
- **#changelog** — automated updates when new code lands on main
- **#docs** — links to all project documentation on GitHub
