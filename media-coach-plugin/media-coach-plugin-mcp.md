...
- MediaCoach.Plugin.CommentaryText — full prompt text (with optional topic title)
- MediaCoach.Plugin.CommentaryVisible — 1/0, controls panel visibility
- MediaCoach.Plugin.CommentaryCategory — for color-coding
- MediaCoach.Plugin.CommentaryTopicTitle — short topic name
- MediaCoach.Plugin.CommentarySecondsRemaining — countdown for progress bar

Dashboard (dashboard/MediaCoach.simhubdash)
