...
namespace K10MediaBroadcaster.Plugin.Engine
{
    ...
    public class ScreenColorSampler : IDisposable
    {
        ...
        public void Start()
        {
            ...
            _thread.Start();
            SimHub.Logging.Current.Info("[K10MediaBroadcaster] ScreenColorSampler started");
        }
        ...
        public void Stop()
        {
            ...
            SimHub.Logging.Current.Info("[K10MediaBroadcaster] ScreenColorSampler stopped");
        }
                ...
                try
                {
                    ...
                    if (frameCount <= 3 || frameCount % 100 == 0)
                    {
                        SimHub.Logging.Current.Info(
                            $"[K10MediaBroadcaster] ScreenColor frame #{frameCount}: " +
                ...
                catch (Exception ex)
                {
                    ...
                    if (frameCount % 100 == 0)
                    {
                        SimHub.Logging.Current.Warn(
                            $"[K10MediaBroadcaster] ScreenColor capture error: {ex.Message}");
                    }
                }
            }
        }
