...
namespace K10MediaCoach.Plugin.Engine
{
    ...
    public class FragmentAssembler
    {
        ...
        /// <summary>
        /// Loads fragment data from the given JSON file.
        ...
        public void LoadFragments(string jsonPath)
        {
            ...
            {
                SimHub.Logging.Current.Warn($"[K10MediaCoach.FragmentAssembler] Fragments file not found: {jsonPath}");
                return;
            }
            ...
            try
            {
                ...
                SimHub.Logging.Current.Info($"[K10MediaCoach.FragmentAssembler] Loaded {_fragments.Count} fragment topics from {jsonPath}");
            }
            catch (Exception ex)
            {
                SimHub.Logging.Current.Error($"[K10MediaCoach.FragmentAssembler] Failed to load fragments: {ex.Message}");
            }
        }
