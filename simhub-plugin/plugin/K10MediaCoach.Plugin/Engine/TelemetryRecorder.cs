...
namespace K10MediaCoach.Plugin.Engine
{
    ...
    /// Use K10MediaCoach.TestRunner to replay recordings and see what prompts fire.
    /// </summary>
    public class TelemetryRecorder : IDisposable
    {
        ...
        public void StartRecording(string directory)
        {
            ...
            try
            {
                ...
                CurrentFile = path;
                SimHub.Logging.Current.Info($"[K10MediaCoach] Recording telemetry to {path}");
            }
            catch (Exception ex)
            {
                SimHub.Logging.Current.Error($"[K10MediaCoach] Failed to start recording: {ex.Message}");
                _writer = null;
                CurrentFile = null;
            }
        }
        ...
        public void StopRecording()
        {
            ...
            _writer.Dispose();
            _writer = null;
            SimHub.Logging.Current.Info($"[K10MediaCoach] Telemetry recording saved to {CurrentFile}");
        }
