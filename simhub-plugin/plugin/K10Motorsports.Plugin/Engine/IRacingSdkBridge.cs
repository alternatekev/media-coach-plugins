...
namespace K10Motorsports.Plugin.Engine
{
    ...
    public sealed class IRacingSdkBridge : IDisposable
    {
        ...
        public void Start()
        {
            ...
            SimHub.Logging.Current.Info("[K10Motorsports] IRacingSdkBridge started");
        }
        ...
        public void Stop()
        {
            ...
            {
                SimHub.Logging.Current.Error("[K10Motorsports] Error stopping SDK: " + ex.Message);
            }

            IsStarted = false;
            IsConnected = false;

            SimHub.Logging.Current.Info("[K10Motorsports] IRacingSdkBridge stopped");
        }
        ...
        {
            IsConnected = true;
            SimHub.Logging.Current.Info("[K10Motorsports] iRacing SDK connected");
        }

        private void OnDisconnected()
        {
            IsConnected = false;
            SimHub.Logging.Current.Info("[K10Motorsports] iRacing SDK disconnected");
        }
        ...
        private void OnSessionInfo()
        {
            ...
            {
                SimHub.Logging.Current.Error("[K10Motorsports] Error parsing session info: " + ex.Message);
            }
        }
