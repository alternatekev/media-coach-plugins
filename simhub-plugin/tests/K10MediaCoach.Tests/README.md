# K10MediaCoach.Tests — Comprehensive Test Suite

A complete unit test project for the SimHub K10 Media Coach plugin. Tests all core logic components without SimHub runtime dependencies.

## Project Structure

```
tests/K10MediaCoach.Tests/
├── K10MediaCoach.Tests.csproj       .NET 6.0 project file, NUnit + NUnit3TestAdapter
├── README.md                         This file
│
...
1. Copy the latest version from `plugin/K10MediaCoach.Plugin/Engine/TriggerEvaluator.cs`
2. Change namespace to `K10MediaCoach.Tests.TestHelpers`
...
- name: Run tests
  run: dotnet test tests/K10MediaCoach.Tests/K10MediaCoach.Tests.csproj
