...
namespace K10MediaCoach.Tests.TestHelpers
{
    /// <summary>
    ...
    public class FragmentAssembler
    {
        ...
        public void LoadFragmentsFromJson(string json)
        {
            ...
            {
                Console.WriteLine("[K10MediaCoach.FragmentAssembler] Empty JSON provided");
                return;
            }
            ...
            try
            {
                ...
                Console.WriteLine($"[K10MediaCoach.FragmentAssembler] Loaded {_fragments.Count} fragment topics");
            }
            catch (Exception ex)
            {
                Console.Error.WriteLine($"[K10MediaCoach.FragmentAssembler] Failed to load fragments: {ex.Message}");
            }
        }
