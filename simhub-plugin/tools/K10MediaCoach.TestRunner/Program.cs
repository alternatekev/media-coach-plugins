...
///
/// Usage:
///   K10MediaCoach.TestRunner.exe <recording.jsonl> <commentary_topics.json>
///
/// The recording file is produced by enabling RecordMode in the plugin settings.
/// Recordings are saved to: %ProgramData%\SimHub\PluginsData\K10MediaCoach\recordings\
/// </summary>

if (args.Length < 2)
{
    Console.WriteLine("Usage: K10MediaCoach.TestRunner <recording.jsonl> <commentary_topics.json>");
    Console.WriteLine();
    Console.WriteLine("Recordings are saved to:");
    Console.WriteLine("  %ProgramData%\\SimHub\\PluginsData\\K10MediaCoach\\recordings\\");
    return 1;
}
