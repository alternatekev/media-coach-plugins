...
An MCP (Model Context Protocol) server that provides structured access to the K10 Media Broadcaster SimHub plugin's source code, configuration, commentary dataset, and telemetry schema.
