...
- K10MediaCoach.Plugin.CommentaryText — full prompt text (with optional topic title)
- K10MediaCoach.Plugin.CommentaryVisible — 1/0, controls panel visibility
- K10MediaCoach.Plugin.CommentaryCategory — for color-coding
- K10MediaCoach.Plugin.CommentaryTopicTitle — short topic name
- K10MediaCoach.Plugin.CommentarySecondsRemaining — countdown for progress bar

Dashboard (dashboard/K10MediaCoach.simhubdash)
...
1. Open plugin/K10MediaCoach.Plugin.sln in Visual Studio on Windows
...
4. In SimHub → Additional Plugins → enable K10 Media Coach, then restart SimHub
5. Copy the dashboard/K10MediaCoach/ folder into SimHub's Dashboards folder, then open it via Dash Studio
